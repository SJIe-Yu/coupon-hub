package edu.seu.couponhub.merchant.admin.service.impl;
...
import edu.seu.couponhub.merchant.admin.common.constant.MerchantAdminRedisConstant;
import edu.seu.couponhub.merchant.admin.common.context.UserContext;
import edu.seu.couponhub.merchant.admin.common.enums.CouponTemplateStatusEnum;
import edu.seu.couponhub.merchant.admin.dao.entity.CouponTemplateDO;
import edu.seu.couponhub.merchant.admin.dao.mapper.CouponTemplateMapper;
...
import edu.seu.couponhub.merchant.admin.mq.event.CouponTemplateDelayEvent;
import edu.seu.couponhub.merchant.admin.mq.producer.CouponTemplateDelayExecuteStatusProducer;
import edu.seu.couponhub.merchant.admin.service.CouponTemplateService;
import edu.seu.couponhub.merchant.admin.service.basics.chain.MerchantAdminChainContext;
...
import static edu.seu.couponhub.merchant.admin.common.constant.CouponTemplateConstant.CREATE_COUPON_TEMPLATE_LOG_CONTENT;
import static edu.seu.couponhub.merchant.admin.common.constant.CouponTemplateConstant.INCREASE_NUMBER_COUPON_TEMPLATE_LOG_CONTENT;
import static edu.seu.couponhub.merchant.admin.common.constant.CouponTemplateConstant.TERMINATE_COUPON_TEMPLATE_LOG_CONTENT;
...
public class CouponTemplateServiceImpl extends ServiceImpl<CouponTemplateMapper, CouponTemplateDO> implements CouponTemplateService {
    ...
    @Override
    public CouponTemplateQueryRespDTO findCouponTemplateByShopNumberAndId(String shopNumber, String couponTemplateId) {
        LambdaQueryWrapper<CouponTemplateDO> queryWrapper = Wrappers.lambdaQuery(CouponTemplateDO.class)
    ...
    @Override
    public void decrementCouponTemplateStock(CouponTemplateStockDecrementReqDTO requestParam) {
        int decremented = couponTemplateMapper.decrementCouponTemplateStock(
                ...
                requestParam.getDecrementStock()
        );

package edu.seu.couponhub.merchant.admin.job;
...
@RestController // 快速测试定时推送的 swagger 接口
@Tag(name = "优惠券定时推送任务") // 快速测试定时推送的 swagger 接口
public class CouponTaskJobHandler extends IJobHandler {
    ...
    @SneakyThrows
    @Operation(summary = "快速测试定时推送的 swagger 接口")

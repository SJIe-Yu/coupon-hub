...
import edu.seu.couponhub.distribution.common.constant.DistributionRedisConstant;
import edu.seu.couponhub.distribution.common.constant.DistributionRocketMQConstant;
import edu.seu.couponhub.distribution.common.constant.EngineRedisConstant;
import edu.seu.couponhub.distribution.common.enums.CouponSourceEnum;
import edu.seu.couponhub.distribution.common.enums.CouponStatusEnum;
import edu.seu.couponhub.distribution.common.enums.CouponTaskStatusEnum;
import edu.seu.couponhub.distribution.dao.entity.CouponTaskDO;
import edu.seu.couponhub.distribution.dao.entity.CouponTaskFailDO;
import edu.seu.couponhub.distribution.dao.entity.CouponTemplateDO;
import edu.seu.couponhub.distribution.dao.entity.UserCouponDO;
...
import edu.seu.couponhub.distribution.dao.mapper.UserCouponMapper;
...
import edu.seu.couponhub.distribution.service.handler.excel.UserCouponTaskFailExcelObject;
...
import static edu.seu.couponhub.distribution.common.constant.EngineRedisConstant.USER_COUPON_TEMPLATE_LIMIT_KEY;
...
public class CouponExecuteDistributionConsumer implements RocketMQListener<MessageWrapper<CouponTemplateDistributionEvent>> {
    ...
    private void decrementCouponTemplateStockAndSaveUserCouponList(CouponTemplateDistributionEvent event) {
        ...
        for (String each : batchUserMaps) {
            ...
            CouponConsumeRule consumeRule = CouponRuleUtil.parseConsumeRule(event.getCouponTemplateConsumeRule());

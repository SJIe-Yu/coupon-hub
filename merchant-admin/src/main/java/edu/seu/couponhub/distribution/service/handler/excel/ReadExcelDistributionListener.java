package edu.seu.couponhub.distribution.service.handler.excel;
...
import edu.seu.couponhub.distribution.toolkit.StockDecrementReturnCombinedUtil;
    ...
    public void invoke(CouponTaskExcelObject data, AnalysisContext context) {
        ...
        if (!firstField) {
            ...
            CouponTaskFailDO couponTaskFailDO = CouponTaskFailDO.builder()
                    ...
                    .jsonObject(JSON.toJSONString(objectMap, JSONWriter.Feature.WriteMapNullValue))
                    .build();

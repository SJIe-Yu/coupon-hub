package edu.seu.couponhub.engine.service.impl;
...
import edu.seu.couponhub.engine.common.context.UserContext;
import edu.seu.couponhub.engine.common.enums.RedisStockDecrementErrorEnum;
import edu.seu.couponhub.engine.common.enums.UserCouponStatusEnum;
import edu.seu.couponhub.engine.dao.entity.CouponSettlementDO;
import edu.seu.couponhub.engine.dao.entity.UserCouponDO;
import edu.seu.couponhub.engine.dao.mapper.CouponSettlementMapper;
import edu.seu.couponhub.engine.dao.mapper.UserCouponMapper;
import edu.seu.couponhub.engine.dto.req.CouponCreatePaymentGoodsReqDTO;
import edu.seu.couponhub.engine.dto.req.CouponCreatePaymentReqDTO;
import edu.seu.couponhub.engine.dto.req.CouponProcessPaymentReqDTO;
import edu.seu.couponhub.engine.dto.req.CouponProcessRefundReqDTO;
...
import edu.seu.couponhub.engine.mq.producer.UserCouponRedeemProducer;
import edu.seu.couponhub.engine.service.CouponTemplateService;
import edu.seu.couponhub.engine.service.UserCouponService;
import edu.seu.couponhub.engine.toolkit.StockDecrementReturnCombinedUtil;
import edu.seu.couponhub.framework.coupon.rule.CouponConsumeRule;
import edu.seu.couponhub.framework.coupon.rule.CouponReceiveRule;
...
import edu.seu.couponhub.framework.exception.ServiceException;
...
import static edu.seu.couponhub.engine.common.constant.EngineRedisConstant.USER_COUPON_TEMPLATE_LIST_KEY;
...
public class UserCouponServiceImpl implements UserCouponService {
    ...
    @Value("${coupon-hub.user-coupon-list.save-cache.type:direct}")
    ...
    public void redeemUserCoupon(CouponTemplateRedeemReqDTO requestParam) {
        ...
        // 验证用户是否符合优惠券领取条件
        CouponReceiveRule receiveRule = CouponRuleUtil.parseReceiveRule(couponTemplate.getReceiveRule());
        String limitPerPerson = String.valueOf(receiveRule.getLimitPerPerson());
